...
<TableRenderer
  headers={["Function", "Meaning", "English Equivalent", "Example"]}
  rows={[
...
<SoplangHighlighter code={`// Output
qor("Hello World")
...
qor("Random: " + r)`}/>
:::info[Gunaanad]
built-ins-ka Soplang waxay ka dhigaan koodhka mid kooban, muujin leh, isla markaana si dabiici ah ugu qoran Af-Soomaali.
:::
