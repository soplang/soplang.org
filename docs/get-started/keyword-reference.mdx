...
<TableRenderer
  headers={["Keyword", "Meaning", "English Equivalent", "Example"]}
  rows={[
    [
      "door",
...
<TableRenderer
  headers={["Somali Value", "English Equivalent", "Description", "Example"]}
  rows={[
...
<TableRenderer
  headers={["Somali Operator", "English Equivalent", "Description", "Example"]}
  rows={[
    ["+", "+", "Addition", "x = a + b"],
    ["-", "-", "Subtraction", "x = a - b"],
