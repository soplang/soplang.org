...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Windows", href: "/downloads" },
      { name: "macOS", href: "/downloads" },
      { name: "Linux/UNIX", href: "/downloads" },
    ],
  },
  {
    title: "Documentation",
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Discord", href: "https://discord.gg/n296G4dd7x", target: "_blank" },
      {
        name: "Discussion",
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--footer-bg)] border-t border-[var(--border-color)]">
      <div className="px-4 py-8 container-custom sm:px-6 lg:px-8 sm:py-12 lg:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border-color)]">
          <div className="flex flex-col items-center space-y-6 sm:space-y-8 lg:flex-row lg:justify-between lg:space-y-0">
            <div className="flex flex-col items-center text-center sm:flex-row sm:space-x-4 sm:text-left">
              ...
              <div className="max-w-sm">
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-500">
                  Soplang is an open-source programming language that lets you work quickly and
          ...
          <div className="mt-8 pt-4 border-t border-[var(--border-color)] text-center">
            <nav className="flex flex-wrap justify-center text-xs text-gray-500 gap-x-4 gap-y-2 dark:text-gray-500">
              <Link href="/privacy" className="hover:text-[var(--primary-color)] hover:underline">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-[var(--primary-color)] hover:underline">
                Terms of Use
              </Link>
              <Link
                href="/trademarks"
              ...
              <Link href="/sitemap" className="hover:text-[var(--primary-color)] hover:underline">
                Sitemap
              </Link>
            </nav>
          </div>
