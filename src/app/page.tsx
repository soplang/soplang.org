        ...
        <div className="px-4 container-custom sm:px-6 lg:px-8">
          <div className="flex flex-col gap-8 lg:flex-row">
            ...
            <div className="w-full lg:w-2/3">
              {/* Introduction */}
              <div className="p-6 soplang-box sm:p-8">
                <h2 className="mb-6 text-2xl soplang-header sm:text-3xl">What is Soplang?</h2>
                <div className="space-y-4 text-base sm:text-lg">
                  <p>
                    ...
                    <strong>Mr Sharafdin</strong> (Sharafdin Yusuf Sharafdin). It allows developers
                    to write code in <strong>native Somali syntax</strong> using familiar keywords,
                  ...
                  <p>
                    ...
                    inclusive, and accessible for Somali peoples.
                  </p>
                  <p>
                    With Soplang, you can "Dhis Software Adigoo Adeegsanaya Afkaaga Hooyo!" (Build
                    software using your mother tongue!)
                  </p>
                </div>
              </div>

              {/* Features */}
              <div className="p-6 mt-8 soplang-box sm:p-8">
                <h2 className="mb-6 text-2xl soplang-header sm:text-3xl">Key Features</h2>
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="feature-card">
                    <h3 className="mb-3 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">
                      Dual Typing System
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300">
                      Use <code>door</code> for dynamic typing, or <code>tiro</code>,{' '}
                  ...
                  <div className="feature-card">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Full support for OOP with <code>fasalka</code>, <code>ka_dhaxal</code>,{' '}
                      <code>cusub</code>, and <code>nafta</code>.
                    </p>
                  </div>
                  <div className="feature-card">
                    <h3 className="mb-3 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Clean syntax for conditionals (<code>haddii</code>, <code>haddii_kale</code>)
                      and loops (<code>ku_celi</code>, <code>inta_ay</code>).
                    </p>
                  </div>
                  <div className="feature-card">
                    <h3 className="mb-3 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      VS Code extension, CLI tool (<code>sop</code>), REPL, and browser runtime
                      (sopScript).
                    </p>
                  </div>
                </div>
                <div className="mt-6">
                  <Link href="/about/features" className="inline-flex items-center soplang-link">
              ...
              {/* Getting Started */}
              <div className="p-6 mt-8 soplang-box sm:p-8">
                <h2 className="mb-6 text-2xl soplang-header sm:text-3xl">Getting Started</h2>
                <p className="mb-4 text-base sm:text-lg">
                  Ready to dive in? Here's how to get started with Soplang:
                </p>
                <ol className="mb-6 space-y-3 text-base list-decimal list-inside sm:text-lg">
                  <li>
                ...
                <div className="p-4 bg-gray-100 rounded-lg dark:bg-gray-800 sm:p-6">
                  <h3 className="mb-4 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">
                    Quick Installation
                  </h3>
                  <CodeWindow
                    code={`// On macOS/Linux
            ...
            <div className="w-full lg:w-1/3">
              ...
              <div className="sticky top-24">
                {websiteSections.map((section) => (
                  <div className="p-6 mb-6 soplang-sidebar-box" key={section.title}>
                ...
                {/* Social Media Links */}
                <div className="p-6 mb-6 soplang-sidebar-box">
