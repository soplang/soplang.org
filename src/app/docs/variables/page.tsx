  ...
  return (
    <div className="py-12 container-custom">
      <div className="mb-12 prose prose-lg dark:prose-invert max-w-none">
        <h1 className="mb-8 text-3xl font-bold md:text-4xl text-primary">Soplang Variables</h1>
        <p className="mb-8 text-xl lead">
          Variables in Soplang are containers for storing data values. Soplang offers the
          flexibility of both dynamic and static typing, allowing you to choose the approach that
          best fits your needs while maintaining type safety.
        </p>
        ...
        <section id="declaration">
          ...
          <p className="mb-4">
            The <code>door</code> keyword is short for <code>doorsoome</code>, which means
            "variable" in Somali. This abbreviation was chosen to make the code more concise while
            preserving its Somali roots.
          </p>
...
door grades = [85, 90, 78, 92]  // List/Array`}
          ...
          <p className="mb-4">
            For more type safety, Soplang also supports static typing where you explicitly declare
...
// qor(width)  // Error: width is not defined in this scope`}
          ...
          <p className="mb-4">
            ...
            "shadows" the global one within its scope.
          </p>
        ...
        <section id="best-practices" className="mt-12">
          ...
          <ul className="space-y-8">
            <li>
              ...
              <p className="mb-2">
                While dynamic typing offers flexibility, static typing helps catch type-related
                errors earlier.
              </p>
              <CodeWindow
