...
const timeline = [
  {
    ...
    title: "The Beginning",
    description:
      "Soplang was conceived as a side project by Mr Sharafdin, who wanted to create the first programming language designed specifically for Somali speakers with modern performance features.",
  },
  {
    year: "2021",
