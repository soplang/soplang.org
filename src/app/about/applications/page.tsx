...
const applications = [
  {
    ...
    description: "Build fast, scalable web applications with Soplang's powerful web frameworks and libraries.",
    features: [
  ...
  {
    title: "Data Science",
    description: "Process and analyze large datasets efficiently with Soplang's data science tools and libraries.",
    features: [
  ...
  },
  {
    ...
    description: "Automate system tasks and manage infrastructure with Soplang's system administration tools.",
    features: [
      "Process management",
...
const industries = [
  {
    name: "Finance",
    description: "Used by financial institutions for data analysis, algorithmic trading, and risk management.",
    icon: (
  ...
  {
    name: "Healthcare",
    description: "Powers medical research, patient data analysis, and healthcare system automation.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    name: "Education",
    description: "Used in educational institutions for teaching programming and building learning platforms.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
